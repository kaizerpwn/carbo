  ...
  return (
    <div className='min-h-screen bg-backgroundDark pb-20 max-w-md mx-auto'>
      ...
      <div className='p-4'>
        <div
          id='step1'
          className={`flex justify-between items-center mb-6 relative ${getZIndexClass(0)}`}
        >
          <div className='flex items-center gap-3'>
            ...
            <div>
              <h1 className='text-white text-lg'>Hello, {user?.fullName.split(' ')[0]}</h1>
        ...
        <div
          id='step3'
          className={`flex justify-between isolate items-center mb-4 relative ${getZIndexClass(2)}`}
        >
            ...
            <div className='space-y-3'>
                      ...
                      <div className='flex items-center gap-4'>
                        ...
                        <div>
                          ...
                          <div className='flex items-center gap-3 mt-1'>
                            <span className='text-sm text-gray-400'>{device.powerRating}W</span>
              ...
              {devices?.filter((device) => device.isFavorite).length === 0 && (
                <div className='text-center py-10'>
                  ...
                  <h3 className='text-white font-medium mb-1'>No Favorite Devices</h3>
                  <p className='text-gray-400 text-sm'>Add devices to favorites to see them here</p>
                </div>
              )}
            </div>
          )}
          ...
          <>
            ...
            >
              <div className='bg-white bg-opacity-10 backdrop-blur-lg text-center rounded-lg p-6 mx-4 pointer-events-auto max-w-[15rem] relative shadow-xl border border-white/30'>
                ...
                <h2 className='text-xl font-bold mb-2 text-white'>{steps[currentStep].title}</h2>
