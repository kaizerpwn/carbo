...
const DevicesView = () => {
  ...
  return (
    <div className='min-h-screen bg-backgroundDark pb-20'>
          ...
          <div>
            ...
            {activeDevices.length > 0 ? (
              ...
              <div className='text-center py-12 bg-backgroundLight rounded-2xl my-4'>
                ...
                <h3 className='text-white font-medium mb-1'>No Active Devices</h3>
                <p className='text-gray-400 text-sm'>Add or activate devices to see them here</p>
              </div>
            )}
          </div>
          ...
          <div>
            ...
            {inactiveDevices.length > 0 ? (
              ...
              <div className='text-center py-12 bg-backgroundLight rounded-2xl my-4'>
                ...
                <h3 className='text-white font-medium mb-1'>No Inactive Devices</h3>
                <p className='text-gray-400 text-sm'>All devices are currently active</p>
              </div>
            )}
          </div>
        </div>
      ...
      <NavBar className={showDeleteModal ? 'opacity-50 pointer-events-none' : ''} />
    </div>
  );
};
